...
TEST(CollatzBadger, eval_1_100000_2) {
    const int v = collatz_eval(1, 100000);
    ASSERT_EQ(351, v);}

TEST(CollatzBadger, eval_1_100000_3) {
    const int v = collatz_eval(1, 100000);
    ASSERT_EQ(351, v);}
...
TEST(CollatzBadger, eval_1_10) {
    const int v = collatz_eval(1, 10);
    ASSERT_EQ(20, v);}

TEST(CollatzBadger, eval_100_200) {
    const int v = collatz_eval(100, 200);
    ASSERT_EQ(125, v);}

TEST(CollatzBadger, eval_201_210) {
    const int v = collatz_eval(201, 210);
    ASSERT_EQ(89, v);}

TEST(CollatzBadger, eval_900_1000) {
    const int v = collatz_eval(900, 1000);
    ASSERT_EQ(174, v);}

TEST(CollatzBadger, eval_1_1) {
    const int v = collatz_eval(1, 1);
    ASSERT_EQ(1, v);}

TEST(CollatzBadger, eval_2_2) {
    const int v = collatz_eval(2, 2);
    ASSERT_EQ(2, v);}

TEST(CollatzBadger, eval_9_9) {
    const int v = collatz_eval(9, 9);
    ASSERT_EQ(20, v);}

TEST(CollatzBadger, eval_10_10) {
    const int v = collatz_eval(10, 10);
    ASSERT_EQ(7, v);}

TEST(CollatzBadger, eval_9_10) {
    const int v = collatz_eval(9, 10);
    ASSERT_EQ(20, v);}

TEST(CollatzBadger, eval_1_3) {
    const int v = collatz_eval(1, 3);
    ASSERT_EQ(8, v);}

TEST(CollatzBadger, eval_2_4) {
    const int v = collatz_eval(2, 4);
    ASSERT_EQ(8, v);}

TEST(CollatzBadger, eval_3_5) {
    const int v = collatz_eval(3, 5);
    ASSERT_EQ(8, v);}

TEST(CollatzBadger, eval_100_210) {
    const int v = collatz_eval(100, 210);
    ASSERT_EQ(125, v);}

TEST(CollatzBadger, eval_10_1) {
    const int v = collatz_eval(10, 1);
    ASSERT_EQ(20, v);}

TEST(CollatzBadger, eval_200_100) {
    const int v = collatz_eval(200, 100);
    ASSERT_EQ(125, v);}

TEST(CollatzBadger, eval_210_201) {
    const int v = collatz_eval(210, 201);
    ASSERT_EQ(89, v);}

TEST(CollatzBadger, eval_1000_900) {
